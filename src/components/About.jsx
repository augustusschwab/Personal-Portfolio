        ...
        <>
            <div className="container">
                ...
                <div className="about">
                    ...
                    My goal is to transition to a higher volume, automated manufacturing environment where I can combine my interest in data and statistics with my love for manufacturing. 
                    </p>  
                </div>
